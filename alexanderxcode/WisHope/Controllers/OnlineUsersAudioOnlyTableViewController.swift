//
//  OnlineUsersAudioOnlyTableViewController.swift
//  WisHope
//
//  Created by Alexander Auraha on 10/23/20.
...
class OnlineUsersAudioOnlyTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "AudioUserCell", for: indexPath)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        userFullName = allOnlineUsers[indexPath.row].firstName! + " " + allOnlineUsers[indexPath.row].lastName!
        userUID = allOnlineUsers[indexPath.row].uid!
        self.performSegue(withIdentifier: "audioCall2", sender: nil)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let videoCallView = segue.destination as! CallOnlyViewController
